...
DEF_OP(LDiv) {
  ...
  switch (OpSize) {
    ...
    case 8: {
      ...
      // Long divide
      {
        mov(EmitSize, PERSIST1, Upper);
        mov(EmitSize, PERSIST2, Lower);
        mov(EmitSize, PERSIST3, Divisor);
  ...
  switch (OpSize) {
    ...
    case 8: {
      ...
      // Long divide
      {
        ...
        ldr(PERSIST4, STATE, offsetof(FEXCore::Core::CpuStateFrame, Pointers.AArch64.LUDIVHandler));
